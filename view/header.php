...
<div class="container">
    <?php if($_SERVER['PHP_SELF'] == '/view/book.php'): ?>
    ...
    <div class="py-5 text-center">
        <img class="d-block mx-auto mb-3" src="<?= ($_SERVER['PHP_SELF'] == '/view/book.php') ? '../': ''?>src/icon.png" alt="" width="82" height="82">
        <h1>Digital Guestbook</h1>
        <p class="lead"><?= ($_SERVER['PHP_SELF'] == '/view/book.php') ? 'What people say about me!':'Write something to your friend!' ?></p>
    </div>